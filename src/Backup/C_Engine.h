...
private:
	...
	// Object Storage
	ObjectMap d_ObjectMap;				// The map of objects and their ID's
	ObjectID d_NewObjectID;				// The object ID to assign
...
public:
	...
	//-----------------------------------------------------------------------
	// clearObjects - Public C_Engine
	// Description 
	//		Deletes the objects stored in the object map.
	//
	// Arguments:	None.
	// Returns:		None.
	//-----------------------------------------------------------------------
	virtual void clearObjects() { d_ObjectMap.clear(); }
	...
	virtual void deleteObject(const ObjectID& id);
	virtual ObjectPtr getObject(const ObjectID& id);
	...
	virtual ObjectItr getObjectBeginIterator() { return d_ObjectMap.begin(); }
	virtual ObjectItr getObjectEndIterator() { return d_ObjectMap.end(); }

...
// Discription:
//	Contains the inferfaces of many of the key classes for the engine.
//======================================================================
...
public:
	...
	virtual void onObjectDeletion(const ObjectID& id) = 0;
...
public:
	...
	typedef ObjectMap::iterator ObjectItr;
	...
	// Global Object Storage interface
	virtual void clearObjects() = 0;
	virtual void addObject(ObjectPtr object) = 0;
	virtual ObjectItr getObjectEndIterator() = 0;
	virtual ObjectItr getObjectBeginIterator() = 0;
	virtual void deleteObject(const ObjectID& id) = 0;
	virtual ObjectPtr getObject(const ObjectID& id) = 0;

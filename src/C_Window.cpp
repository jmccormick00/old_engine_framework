...
d_hAppInstance(0), d_hMainWindow(0), d_MainWndCaption(""),
...
bool C_Window::initWindow(HINSTANCE hInst, std::string windowName, unsigned windowWidth, unsigned windowHeight, bool fullScreen) {
	...
	if(fullScreen)
	{
		d_hMainWindow = CreateWindowEx(NULL,
				"D3DWndClassName",    // name of the window class
				d_MainWndCaption.c_str(),   // title of the window
				WS_EX_TOPMOST | WS_POPUP,    // window style
				0,    // x-position of the window
				0,    // y-position of the window
				d_iClientWidth,    // width of the window
				d_iClientHeight,    // height of the window
	...
	else
	{
		...
		d_hMainWindow = CreateWindowEx(WS_EX_APPWINDOW,
			"D3DWndClassName",    // name of the window class
			d_MainWndCaption.c_str(),   // title of the window
	...
	if(d_hMainWindow == NULL) {
		DEBUGLOG("Window Creation FAILED.");
		//MessageBox(0, L"CreateWindow FAILED", 0, 0);
		PostQuitMessage(0);
		return false;
	} else {
		DEBUGLOG("Window Creation SUCCESSFUL.");

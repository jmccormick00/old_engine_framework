...
public:
	...
	void setWindowCaption(const  std::string& cap) { d_MainWndCaption = cap; }
	...
	bool initWindow(HINSTANCE hInst, std::string windowName, unsigned windowWidth, unsigned windowHeight, bool fullScreen);
};
